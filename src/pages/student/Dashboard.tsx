...
const StudentDashboard: React.FC = () => {
  ...
  const subjectProgress = [
    { subject: 'mathematics', name: 'Mathematics', completed: 12, total: 20, percentage: 60 },
    { subject: 'science', name: 'Science', completed: 8, total: 15, percentage: 53 },
    { subject: 'social', name: 'Social Science', completed: 5, total: 15, percentage: 33 },
    { subject: 'mat', name: 'Mental Ability', completed: 7, total: 10, percentage: 70 },
  ];

  // Mock recent activity
  const recentActivity = [
    { type: 'quiz', title: 'Basic Mathematics Quiz', score: '8/10', date: '2025-05-12' },
    { type: 'practice', title: 'Science Practice', score: '5/7', date: '2025-05-10' },
  ];
        ...
        <div className="edu-container">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Class: {user?.class} | Institute ID: {user?.instituteId}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <Card className="border-2 border-edu-blue/20 hover:border-edu-blue/40 transition-colors">
              <CardHeader>
                ...
                <CardDescription>Attempt subject-specific practice questions</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-500">
                  Select a subject and practice MCQ questions to improve your skills for the NMMS exam.
                </p>
              </CardContent>
              <CardFooter>
            ...
            <Card className="border-2 border-edu-green/20 hover:border-edu-green/40 transition-colors">
              <CardHeader>
                ...
                <CardDescription>Enter a Quiz ID to take a teacher-created quiz</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-500">
                  Enter a Quiz ID provided by your teacher to attempt a specific quiz.
                </p>
              </CardContent>
              <CardFooter>
                <Link to="/student/quiz" className="w-full">
            ...
            <Card className="border-2 border-edu-purple/20 hover:border-edu-purple/40 transition-colors">
              <CardHeader>
                ...
                <CardDescription>Study with two friends in group mode</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-500">
                  Enter your ID and your friends' IDs to attempt a quiz together as a group.
                </p>
              </CardContent>
              <CardFooter>
            ...
            {recentActivity.length > 0 ? (
                    ...
                    <CardHeader className="py-3">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center">
                          <span className="text-sm font-medium mr-4">{activity.score}</span>
              ...
              <Card>
                <CardContent className="py-6 flex flex-col items-center justify-center">
                  ...
                  <p className="text-xl font-medium text-gray-500">No activity yet</p>
                  <p className="text-gray-500 mb-4">Start practicing to build your activity history</p>
